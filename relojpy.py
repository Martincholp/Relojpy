...
class Segmento(pygame.Surface):
	...
	def __init__(self, rect):
		...
		if rect[2] < rect[3]:
			...
			self.largo = rect[3]
			self.ancho = rect[2]
	        self.ptos = [(0 ,self.ancho/2),(self.ancho/2 ,0),(self.ancho ,self.ancho/2),(self.ancho ,self.largo-self.ancho/2),(self.ancho/2 ,self.largo),(0,self.largo-self.ancho/2)]
		else:
			self.orientacion = "H"
			self.largo = rect[2]
			self.ancho = rect[3]
